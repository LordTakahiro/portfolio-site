              ...
              <div className="resume__experience">
                <div className="resume__job">
                  ...
                  <ul className="resume__job-list">
                    <li><strong>Triarchy: Houses of Mythos — Mobile Gacha RPG (In Development):</strong> Sole designer and developer of a mobile gacha RPG for iOS/Android built in Godot 4; designed 132 heroes across 11 tribes with full stats, abilities, and tribal synergies; authored complete GDD/TDD including combat engine, gacha pity system, Firebase backend schema, guild alliance mechanics, and 90-day seasonal reset system; implemented working prototype with turn-based combat, hero database, cloud save, and gacha summoning; seeking investment for professional art production</li>
